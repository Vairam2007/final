...
export default function HallOfFamePage() {
  ...
  // Reset showContent to false when topic changes
  useEffect(() => {
    ...
    <section className="relative min-h-screen w-full bg-gradient-to-br from-[#0a0a1f] via-[#0a0a2f] to-[#0f0f30] text-white pt-24 px-4 md:px-12 lg:px-20 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col md:flex-row gap-10 max-w-7xl mx-auto">
        ...
        <main
          ...
          className="md:w-3/4 bg-[#11112a]/80 border border-gray-700 rounded-2xl p-4 md:p-6 shadow-xl backdrop-blur-sm max-h-[500px] flex flex-col transition-all duration-500 ease-in-out"
        >
          {!showContent ? (
            <>
              <img
